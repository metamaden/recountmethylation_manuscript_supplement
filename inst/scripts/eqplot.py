...
def gsm_eqtable(startdate=2000,enddate=2018,
    platformlist = ['GPL13534','GPL8490','GPL21145','GPL9183','GPL22378',
    'GPL16284','GPL17148','GPL5082'],
...
def gseidat_eqtable(startdate=2000,enddate=2018,
    platformlist = ['GPL13534','GPL8490','GPL21145'],tablename='gseidatyrdat',
    writetable=True):
    """
    """
    yearrange = list(range(startdate-1,enddate+1))  
...
from eqplot import gsm_eqtable, gse_eqtable
